...
/* Voting... */
    ...
    function voteFor(uint256 _answer) isNotBlackListed(msg.sender) public nonReentrant{
        uint256 _eventID = votingEventID;
        ...
        uint256 mainPower;
         if(_eventID > investor[msg.sender].votedForEvent){
            ...
            require(lockedBasePower > voteFee,"Need more Acces");
            investor[voter].amount -= voteFee;
